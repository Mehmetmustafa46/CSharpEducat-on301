...
namespace CSharpEducatıon301.EFProject
{
    public partial class FrmStatistics : Form
    {
        ...
        private void FrmStatistics_Load(object sender, EventArgs e)
        {
            ...
            lblCapacity.Text = db.Location.Average(x=>x.Capacity).ToString();   
            ...
            lblRomeGuideName.Text=db.Guide.Where(x=>x.GuideId == romeGuideId).Select(y =>y .GuideName + " " + y.GuideSurname).First().ToString();
